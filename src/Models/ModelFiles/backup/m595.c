...
chemical equilibrium as a function of T
minimum phi=0.
RH calculated
iff changed
 */
...
/* Charge of ions */
#include "../DataBases/ElectricChargeOfIons.h"
#define z_ca          ElectricChargeOfIons(Ca)
#define z_h           ElectricChargeOfIons(H)
#define z_oh          ElectricChargeOfIons(OH)
#define z_hco3        ElectricChargeOfIons(HCO3)
#define z_co3         ElectricChargeOfIons(CO3)
#define z_h3sio4      ElectricChargeOfIons(H3SiO4)
#define z_cahco3      ElectricChargeOfIons(CaHCO3)
#define z_cah3sio4    ElectricChargeOfIons(CaH3SiO4)
#define z_h2sio4      ElectricChargeOfIons(H2SiO4)
#define z_caoh        ElectricChargeOfIons(CaOH)
#define z_k           ElectricChargeOfIons(K)
#define z_cl          ElectricChargeOfIons(Cl)

/* Partial Molar Volume of Ions (dm3/mole) */
#include "../DataBases/PartialMolarVolumeOfMoleculesInWater.h"
#define dm3            (1.e3)
#define v_h            (PartialMolarVolumeOfMoleculesInWater(H)*dm3)
#define v_oh           (PartialMolarVolumeOfMoleculesInWater(OH)*dm3)
#define v_h2o          (PartialMolarVolumeOfMoleculesInWater(H2O)*dm3)
#define v_co2          (PartialMolarVolumeOfMoleculesInWater(CO2)*dm3)
#define v_h2co3        (PartialMolarVolumeOfMoleculesInWater(H2CO3)*dm3)
#define v_hco3         (PartialMolarVolumeOfMoleculesInWater(HCO3)*dm3)
#define v_co3          (PartialMolarVolumeOfMoleculesInWater(CO3)*dm3)
#define v_ca           (PartialMolarVolumeOfMoleculesInWater(Ca)*dm3)
#define v_h3sio4       (PartialMolarVolumeOfMoleculesInWater(H3SiO4)*dm3)
#define v_h2sio4       (PartialMolarVolumeOfMoleculesInWater(H2SiO4)*dm3)
#define v_cah2sio4     (PartialMolarVolumeOfMoleculesInWater(CaH2SiO4)*dm3)
#define v_cah3sio4     (PartialMolarVolumeOfMoleculesInWater(CaH3SiO4)*dm3)
#define v_caco3aq      (PartialMolarVolumeOfMoleculesInWater(CaCO3)*dm3)
#define v_caoh         (PartialMolarVolumeOfMoleculesInWater(CaOH)*dm3)
#define v_k            (PartialMolarVolumeOfMoleculesInWater(K)*dm3)
#define v_koh          (PartialMolarVolumeOfMoleculesInWater(KOH)*dm3)
#define v_cl           (PartialMolarVolumeOfMoleculesInWater(Cl)*dm3)
#define v_h4sio4       (PartialMolarVolumeOfMoleculesInWater(H4SiO4)*dm3)
#define v_cahco3       (PartialMolarVolumeOfMoleculesInWater(CaHCO3)*dm3)
#define v_na           (PartialMolarVolumeOfMoleculesInWater(Na)*dm3)
#define v_naoh         (PartialMolarVolumeOfMoleculesInWater(NaOH)*dm3)
#define v_naco3        (PartialMolarVolumeOfMoleculesInWater(NaCO3)*dm3)
#define v_nahco3       (PartialMolarVolumeOfMoleculesInWater(NaHCO3)*dm3)


/* Viscosity (Pa.s) */
#include "../DataBases/WaterViscosity.h"
#define T			     temperature
#define mu_l       WaterViscosity(T)
#define T0			   (298.0)
#define mu_l25     (8.904695e-04)


/* Diffusion Coefficient Of Molecules In Water (dm2/s) */
#include "../DataBases/DiffusionCoefficientOfMoleculesInWater.h"
#define dm2            (1.e2)
#define d_oh           (DiffusionCoefficientOfMoleculesInWater(OH,T)*dm2)
#define d_h            (DiffusionCoefficientOfMoleculesInWater(H,T)*dm2)
#define d_co2          (DiffusionCoefficientOfMoleculesInWater(CO2,T)*dm2)
#define d_hco3         (DiffusionCoefficientOfMoleculesInWater(HCO3,T)*dm2)
#define d_co3          (DiffusionCoefficientOfMoleculesInWater(CO3,T)*dm2)
#define d_ca           (DiffusionCoefficientOfMoleculesInWater(Ca,T)*dm2)
/*
#define d_caoh         (DiffusionCoefficientOfMoleculesInWater(CaOH,T)*dm2)
#define d_cahco3       (DiffusionCoefficientOfMoleculesInWater(CaHCO3,T)*dm2)
#define d_h4sio4       (DiffusionCoefficientOfMoleculesInWater(H4SiO4,T)*dm2)
#define d_h3sio4       (DiffusionCoefficientOfMoleculesInWater(H3SiO4,T)*dm2)
#define d_h2sio4       (DiffusionCoefficientOfMoleculesInWater(H2SiO4,T)*dm2)
#define d_cah2sio4     (DiffusionCoefficientOfMoleculesInWater(CaH2SiO4,T)*dm2)
#define d_cah3sio4     (DiffusionCoefficientOfMoleculesInWater(CaH3SiO4,T)*dm2)
*/
#define d_caco3aq      (DiffusionCoefficientOfMoleculesInWater(CaCO3,T)*dm2)
#define d_k            (DiffusionCoefficientOfMoleculesInWater(K,T)*dm2)
#define d_koh          (DiffusionCoefficientOfMoleculesInWater(KOH,T)*dm2)
#define d_cl           (DiffusionCoefficientOfMoleculesInWater(Cl,T)*dm2)
#define d_na           (DiffusionCoefficientOfMoleculesInWater(Na,T)*dm2)

/*
#define d_oh       ((5.273e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_h        ((9.311e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_co2      ((1.91e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_hco3     ((1.185e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_co3      ((9.55e-8)*((T*mu_l25)/(T0*mu_l)))
#define d_ca       ((7.92e-8)*((T*mu_l25)/(T0*mu_l)))
*/
#define d_caoh     ((1.07e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_cahco3   ((1.07e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_h4sio4   ((1.07e-8)*((T*mu_l25)/(T0*mu_l)))
#define d_h3sio4   ((1.07e-8)*((T*mu_l25)/(T0*mu_l)))
#define d_h2sio4   ((1.07e-8)*((T*mu_l25)/(T0*mu_l)))
#define d_cah2sio4 ((1.07e-8)*((T*mu_l25)/(T0*mu_l)))
#define d_cah3sio4 ((1.07e-8)*((T*mu_l25)/(T0*mu_l)))
/*
#define d_caco3aq  ((1.43e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_k        ((1.957e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_koh      ((1.96e-7)*((T*mu_l25)/(T0*mu_l)))   
#define d_cl       ((2.032e-7)*((T*mu_l25)/(T0*mu_l)))
#define d_na       ((1.334e-7)*((T*mu_l25)/(T0*mu_l)))
*/
 
/* Equilibrium Constants (ref = 1 mole/L) */
#define T_K        temperature
#define K_h2o      product_k(T_K,-2.839710E+02,-5.069842E-02,1.332300E+04,1.022445E+02,-1.119669E+06)      /* autoprotolyse de l'eau */
#define K_henry    (1.238)           /* cste de Henry du CO2 / RT */

#define K_h2co3    (1.7e-3)          /* 1.7e-3 CO2[0] + H2O = H2CO3 */
/* #define K_hco3     (2.5e-4)          H2CO3   = HCO3[-] + H[+] */
#define K_hco3     1./product_k(T_K,3.563094E+02,6.091964E-02,-2.183437E+04,-1.268339E+02,1.684915E+06)  /*log_k=-6.3519 CO2aq+H2O   = HCO3[-] + H[+] */
#define K_co3      product_k(T_K,-1.078871E+02,-3.252849E-02,5.151790E+03,3.892561E+01,-5.637139E+05)        
/* 4.69e-11 HCO3[-] = CO3[2-] + H[+] */

#define K_h2sio4   product_k(T_K,-1.000033E+01,0.000000E+00,-3.917593E+03,0.000000E+00,-0.000000E+00)/K_h2o/K_h3sio4          
 /*4.68 H3SiO4[-] + OH[-] = H2SiO4[2-] + H2O */
/* #define K_h4sio4   1./product_k(T_K,-5.324993E+00,0.000000E+00,-1.337205E+03,0.000000E+00,-0.000000E+00)         (6.45e9) H3SiO4[-] + H[+] = H4SiO4 */
#define K_h3sio4   product_k(T_K,-5.324993E+00,0.000000E+00,-1.337205E+03,0.000000E+00,-0.000000E+00)         /* (1/6.45e9)  H4SiO4 = H3SiO4[-] + H[+]*/

#define K_cahco3   product_k(T_K,1.209120E+03,3.129400E-01,-3.476505E+04,-4.787820E+02,0.000000E+00)       
/* 1.276e+1 Ca[2+] + HCO3[-]    = CaHCO3[+] */
#define K_caco3aq  product_k(T_K,-1.336619E+03,-3.319725E-01,4.066454E+04,5.247436E+02,-5.637139E+05)/K_co3           
/* 1.4e+3 Ca[2+] + CO3[2-]    = CaCO3[0] */
#define K_cah2sio4 product_k(T_K,4.600000E+00,0.000000E+00,0.000000E+00,0.000000E+00,0.000000E+00)        
/* 3.98e+4 Ca[2+] + H2SiO4[2-] = CaH2SiO4 */
#define K_cah3sio4 product_k(T_K,1.200000E+00,0.000000E+00,0.000000E+00,0.000000E+00,0.000000E+00)         
/* 1.58e+1 Ca[2+] + H3SiO4[-]  = CaH3SiO4[+] */
#define K_caoh     product_k(T_K,-1.278000E+01,0.000000E+00,0.000000E+00,0.000000E+00,0.000000E+00)/K_h2o         
/*1.676439e+01 Ca[2+] + OH[-] = CaOH[+] */
...
/* Equilibrium Constants (ref = 1 mole/L) */
#define K_CH       product_k(T_K,7.643067E-02,-0.000000E+00,6.775032E+03,-0.000000E+00,0.000000E+00)*K_h2o*K_h2o       /*(6.456e-6)  logk = -5.2 CH = Ca[2+] + 2OH[-] */
#define K_CC       product_k(T_K,-6.401940E+01,-4.546451E-02,-2.312471E+03,3.266939E+01,5.637139E+05)*K_co3        
/* 3.89e-9 logk = -8.36 CC = Ca[2+] + CO3[2-]  */ 

/* Curves */
#define SaturationDegree(pc)                courbe(pc,el.mat->cb[0])
#define DerivativeOfSaturationDegree(pc)    dcourbe(pc,el.mat->cb[0])
#define RelativePermeabilityToLiquid(pc)    courbe(pc,el.mat->cb[1])
#define RelativePermeabilityToGas(pc)       courbe(pc,el.mat->cb[2])
/* C-S-H */
/* Equilibrium Constants (ref = 1 mole/L) */
...
#define K_Sam       product_k(T_K,-1.571955E-01,-0.000000E+00,-7.623113E+02,-0.000000E+00,0.000000E+00)   /* 1.93642e-3 S + 2H2O = H4SiO4 */
/* Amorphous Silica Solid fraction */
#define F_SAM(q)    courbe(q,el.mat->cb[6])
#define DF_SAM(q)   dcourbe(q,el.mat->cb[6])


/* Molar Masses (unit mass = M_H) */
#include "../DataBases/MolarMassOfMolecules.h"
#define M_Ca    		   MolarMassOfMolecules(Ca)
#define M_H2CO3  		   MolarMassOfMolecules(H2CO3)
#define M_HCO3   		   MolarMassOfMolecules(HCO3)
#define M_CO3    		   MolarMassOfMolecules(CO3)
#define M_OH     		   MolarMassOfMolecules(OH)
#define M_H      		   MolarMassOfMolecules(H)
#define M_H2O    		   MolarMassOfMolecules(H2O)
#define M_Na	 		     MolarMassOfMolecules(Na)
#define M_NaOH	  	 	 MolarMassOfMolecules(NaOH)
#define M_NaHCO3  		 MolarMassOfMolecules(NaHCO3)
#define M_NaCO3	  		 MolarMassOfMolecules(NaCO3)
#define M_CO2     	 	 MolarMassOfMolecules(CO2)
#define M_CaOH2   	 	 MolarMassOfMolecules(CaOH2)
#define M_CaCO3   		 MolarMassOfMolecules(CaCO3)
#define M_CaO 			   MolarMassOfMolecules(CaO)
#define M_SiO2 			   MolarMassOfMolecules(SiO2)
...
#define M_K      	 	   MolarMassOfMolecules(K)
#define M_KOH    		   MolarMassOfMolecules(KOH)
#define M_CaOH    		 MolarMassOfMolecules(CaOH)
#define M_CaHCO3  		 MolarMassOfMolecules(CaHCO3)
#define M_CaCO3aq 		 MolarMassOfMolecules(CaCO3)
#define M_CaOH2aq  		 MolarMassOfMolecules(CaOH2)
#define M_CaH2SiO4 		 MolarMassOfMolecules(CaH2SiO4)
#define M_CaH3SiO4  	 MolarMassOfMolecules(CaH3SiO4)
#define M_H3SiO4  		 MolarMassOfMolecules(H3SiO4)
#define M_H2SiO4  		 MolarMassOfMolecules(H2SiO4)
#define M_H4SiO4  		 MolarMassOfMolecules(H4SiO4)
#define M_Cl	  		   MolarMassOfMolecules(Cl)
#define M_H2Og	  		 MolarMassOfMolecules(H2O)

#define C_CO2_eq   (K_h2o*K_h2o*K_CC/(K_hco3*K_co3*K_CH))
#define P_CO2_eq   (C_CO2_eq/dproductco2_co2(1.e4,p_l,temperature))/*(K_h2o*K_h2o*K_CC/(K_h2co3*K_hco3*K_co3*K_CH)*1.e8)*/

/* constantes physiques */
#define FARADAY   (9.64846e7) /* Faraday (mC/mole = Pa.dm3/V/mole) */
#define RT        (8.3143e3*T)   /* 2436.e3 produit de R=8.3143 et T=293 (Pa.dm3/mole) */
#define FsRT      (FARADAY/(RT))   /*3.961e1 at T=293K F/RT (1/V) */
...
static double product_Eta(double,double,double,elem_t) ;
...
static double product_k(double,double,double,double,double,double) ;
...
int dm595(int dim,mate_t *mat,FILE *ficd)
/* Lecture des donnees materiaux dans le fichier ficd */
{
...

  {
    ...
    temperature  = mat->pr[pm("temperature")] ;
...
void tb595(elem_t *el,inte_t *fi,unsigned int *n_fi,int dim)
{
  el->n_vi = NVI ;
  el->n_ve = NVE ;
}
...
void ch595(double **x,double **u_1,double **u_n,double *f_1,double *f_n,double *va,double *r,elem_t el,int dim,geom_t geom,double dt,double t,char_t cg)
...
void in595(double **x,double **u,double *f,double *va,elem_t el,int dim,geom_t geom)
/* Initialise les variables du systeme (f,va) */ 
{
  ...
  */
  ...
  for(i=0;i<el.nn;i++) {
    ...
    double c_co2      = (product_co2(p_co2,p_l,temperature) > 0.) ? product_co2(p_co2,p_l,temperature) : C_CO2_eq ; /*(co2 concentration in water)(C_CO2(i) > 0.) ? C_CO2(i) : c_co2_eq ;*/
    ...
    double c_h4sio4   = ((zn_si_s>=0.)?1.:product_Eta(c_co2,zn_ca_s,zn_si_s,el)) *x_s* K_Sam ;
    ...
    double c_h2o      = (1. - (c_co2*v_co2 + c_hco3*v_hco3 + c_co3*v_co3 + c_h*v_h + c_oh*v_oh + c_ca*v_ca \
						...
						/* + x_na*v_na + x_naoh*v_naoh + x_nahco3*v_nahco3 + x_naco3*v_naco3 + x_k*v_k + c_h2co3*v_h2co3 +\
						 * x_koh*v_koh + c_caoh2aq*v_caoh2aq \*/

    /* masse volumique liquide */
    double rho_l   = M_CO2*c_co2 + M_H*c_h + M_OH*c_oh + M_H2O*c_h2o + M_HCO3*c_hco3 + M_CO3*c_co3 + M_Ca*c_ca \
			...
			/* + M_Na*x_na + M_NaOH*x_naoh + M_NaHCO3*x_nahco3 + M_NaCO3*x_naco3 + M_KOH*x_koh + M_CaOH2aq*x_caoh2aq+ M_H2CO3*c_h2co3 */
    ...
    N_C(i)  = n_co2 + n_hco3 + n_co3 + n_cahco3 + n_cc + n_caco3aq ;
...
int ex595(double **x,double **u,double *f,double *va,elem_t el,int dim,geom_t geom,double t) 
...
int ct595(double **x,double **u,double **u_n,double *f,double *f_n,double *va,elem_t el,int dim,geom_t geom,double dt,double t)
...
int mx595(double **x,double **u,double **u_n,double *f,double *f_n,double *va,double *k,elem_t el,int dim,geom_t geom,double dt,double t)
/* Matrice (k) */
{
#define K(i,j)    (k[(i)*2*NEQ+(j)])
  ...
  */
  for(i=0;i<2;i++) {
    ...
    double dc_hco3sdp_co2     = c_hco3*(dc_co2sdp_co2/c_co2 + dc_ohsdp_co2/c_oh) ;
    ...
    double c_h4sio42		  = ((zn_si_s>=0.)?1.:product_Eta(c_co22,zn_ca_s,zn_si_s,el)) *x_s2* K_Sam ;    
    double dc_h4sio4sdp_co2   = dc_co2sdp_co2*(c_h4sio42-c_h4sio4)/dc_co2 ;
    ...
    double dphisdp_co2        = (- V_CH*dn_chsdp_co2 - dv_cshsdp_co2*n_si_s - V_CC*dn_ccsdp_co2)* (phi>0. ? 1. : 0. ) ;
    double dc_h2osdp_co2      = -(dc_co2sdp_co2*v_co2 + v_hco3*dc_hco3sdp_co2 + v_co3*dc_co3sdp_co2 + v_h*dc_hsdp_co2 \
	...
	double drho_lsdp_co2	  = M_H2O*dc_h2osdp_co2 + dc_co2sdp_co2*M_CO2 + M_HCO3*dc_hco3sdp_co2 + M_CO3*dc_co3sdp_co2 + M_H*dc_hsdp_co2 \
	...
	double ds_lsdp_co2        = DerivativeOfSaturationDegree(p_c) ;
	double ds_gsdp_co2        = 0.- DerivativeOfSaturationDegree(p_c) ;	
    ...
    double dc_hco3sdp_l     = c_hco3*(dc_co2sdp_l/c_co2 + dc_ohsdp_l/c_oh) ;
    ...
    double dc_h4sio4sdp_l   = dc_co2sdp_l*(c_h4sio42-c_h4sio4)/dc_co2 ;
    ...
    double dphisdp_l        = (- V_CH*dn_chsdp_l - dv_cshsdp_l*n_si_s - V_CC*dn_ccsdp_l)*(phi>0. ? 1. : 0. ) ;
    double dc_h2osdp_l      = -(dc_co2sdp_l*v_co2 + v_hco3*dc_hco3sdp_l + v_co3*dc_co3sdp_l + v_h*dc_hsdp_l \
	...
	double drho_lsdp_l	  = M_H2O*dc_h2osdp_l + dc_co2sdp_l*M_CO2 + M_HCO3*dc_hco3sdp_l + M_CO3*dc_co3sdp_l + M_H*dc_hsdp_l \
    ...
    double ds_lsdp_l        = 0.- DerivativeOfSaturationDegree(p_c) ;
	double ds_gsdp_l        = DerivativeOfSaturationDegree(p_c) ;		
	...
	double c_h4sio43		  = ((zn_si_s2>=0.)?1.:product_Eta(c_co2,zn_ca_s,zn_si_s2,el)) *x_s3* K_Sam ; 
	
    double dc_h4sio4sdzn_si_s   = (c_h4sio43-c_h4sio4)/dzn_si_s ;
    ...
    double dphisdzn_si_s   	  = (-v_csh*dn_si_ssdzn_si_s)*(phi>0. ? 1. : 0. ) ;
	...
	double c_h4sio44		  = ((zn_si_s>=0.)?1.:product_Eta(c_co2,zn_ca_s2,zn_si_s,el)) *x_s4* K_Sam ; 
	
    double dc_h4sio4sdzn_ca_s   = (c_h4sio44-c_h4sio4)/dzn_ca_s ;
    ...
    double dphisdzn_ca_s    	   = (- V_CH*dn_chsdzn_ca_s - V_CC*dn_ccsdzn_ca_s - dv_cshsdzn_ca_s*n_si_s)*(phi>0. ? 1. : 0. );
    ...
    */
    K(E_C+j,I_CO2+j)   += volume[i]*(dn_co2sdp_co2 + dn_hco3sdp_co2 + dn_co3sdp_co2 + dn_cahco3sdp_co2 \
                          + dn_caco3aqsdp_co2 + dn_ccsdp_co2 ) ;
    K(E_C+j,I_P_l+j)     += volume[i]*(dn_co2sdp_l + dn_hco3sdp_l + dn_co3sdp_l + dn_cahco3sdp_l \
                          + dn_caco3aqsdp_l + dn_ccsdp_l) ;                 
    K(E_C+j,I_Ca_S+j)  += volume[i]*(dn_co2sdzn_ca_s + dn_hco3sdzn_ca_s + dn_co3sdzn_ca_s + dn_cahco3sdzn_ca_s \
                          + dn_caco3aqsdzn_ca_s + dn_ccsdzn_ca_s) ;
    K(E_C+j,I_Si_S+j)   += volume[i]*(dn_co2sdzn_si_s + dn_hco3sdzn_si_s + dn_co3sdzn_si_s + dn_cahco3sdzn_si_s \
                          + dn_caco3aqsdzn_si_s) ;
  ...
  */
  for(i=0;i<2;i++){
    c[i] = trd_co2 + trd_hco3 + trd_co3 + trd_cahco3 + trd_caco3aq + trf_co2*Dc_co2SDp_l[i] + trf_hco3*Dc_hco3SDp_l[i] + trf_co3*Dc_co3SDp_l[i] \
  ...
  for(i=0;i<2;i++){
    c[i] = trg_co2 + trf_co2*Dc_co2SDp_co2[i] + trf_hco3*Dc_hco3SDp_co2[i] + trf_co3*Dc_co3SDp_co2[i] \
  ...
  */
  ...
  for(i=0;i<2;i++){
    c[i] = M_H2Og*trg_h2o + M_CO2*trg_co2 ; 
  }
  K(E_mass,I_CO2)         += + c[0] ;
...
for(i=0;i<2;i++){
    c[i] = M_H*tre_h + M_OH*tre_oh + M_HCO3*tre_hco3 + M_CO3*tre_co3 + M_Ca*tre_ca + M_CaHCO3*tre_cahco3 + M_CaH3SiO4*tre_cah3sio4 \
			+ M_H3SiO4*tre_h3sio4  + M_H2SiO4*tre_h2sio4 + M_CaOH*tre_caoh + M_K*tre_k + M_Cl*tre_cl - M_H2O*(v_h*tre_h + v_oh*tre_oh + v_hco3*tre_hco3 + v_co3*tre_co3 + v_ca*tre_ca + v_cahco3*tre_cahco3 + v_cah3sio4*tre_cah3sio4 \
			+ v_h3sio4*tre_h3sio4  + v_h2sio4*tre_h2sio4 + v_caoh*tre_caoh + v_k*tre_k + v_cl*tre_cl)/v_h2o;
  }
  K(E_mass,I_psi)          += + c[0] ;
  ...
  for(i=0;i<2;i++){
    c[i] = M_H*trf_h*Dc_hSDp_co2[i] + M_OH*trf_oh*Dc_ohSDp_co2[i] + M_CO2*trf_co2*Dc_co2SDp_co2[i] + M_HCO3*trf_hco3*Dc_hco3SDp_co2[i] \
    ...
    - M_H2O*(v_h*trf_h*Dc_hSDp_co2[i] + v_oh*trf_oh*Dc_ohSDp_co2[i] + v_co2*trf_co2*Dc_co2SDp_co2[i] + v_hco3*trf_hco3*Dc_hco3SDp_co2[i] \
    + v_co3*trf_co3*Dc_co3SDp_co2[i] + v_cahco3*trf_cahco3*Dc_cahco3SDp_co2[i] + v_ca*trf_ca*Dc_caSDp_co2[i] \
    + v_cah3sio4*trf_cah3sio4*Dc_cah3sio4SDp_co2[i] + v_h3sio4*trf_h3sio4*Dc_h3sio4SDp_co2[i] + v_h2sio4*trf_h2sio4*Dc_h2sio4SDp_co2[i]\
    + v_caoh*trf_caoh*Dc_caohSDp_co2[i] + v_h4sio4*trf_h4sio4*Dc_h4sio4SDp_co2[i] + v_cah2sio4*trf_cah2sio4*Dc_cah2sio4SDp_co2[i] \
    + v_caco3aq*trf_caco3aq*Dc_caco3aqSDp_co2[i])/v_h2o ;
  }
  K(E_mass,I_CO2)         += + c[0] ;
  K(E_mass,I_CO2+NEQ)     += - c[1] ;
  K(E_mass+NEQ,I_CO2)     += - c[0] ;
  ...
  for(i=0;i<2;i++){
    ...
    - M_H2O*(v_h*trf_h*Dc_hSDzn_ca_s[i] + v_oh*trf_oh*Dc_ohSDzn_ca_s[i] + v_hco3*trf_hco3*Dc_hco3SDzn_ca_s[i] \
    + v_co3*trf_co3*Dc_co3SDzn_ca_s[i] + v_cahco3*trf_cahco3*Dc_cahco3SDzn_ca_s[i] + v_ca*trf_ca*Dc_caSDzn_ca_s[i] \
    + v_cah3sio4*trf_cah3sio4*Dc_cah3sio4SDzn_ca_s[i] + v_h3sio4*trf_h3sio4*Dc_h3sio4SDzn_ca_s[i] + v_h2sio4*trf_h2sio4*Dc_h2sio4SDzn_ca_s[i]\
    + v_caoh*trf_caoh*Dc_caohSDzn_ca_s[i] + v_h4sio4*trf_h4sio4*Dc_h4sio4SDzn_ca_s[i] + v_cah2sio4*trf_cah2sio4*Dc_cah2sio4SDzn_ca_s[i] \
    + v_caco3aq*trf_caco3aq*Dc_caco3aqSDzn_ca_s[i])/v_h2o ;
  }
  K(E_mass,I_Ca_S)         += + c[0] ;
  ...
  for(i=0;i<2;i++){
    ...
    - M_H2O*(v_h*trf_h*Dc_hSDzn_si_s[i] + v_oh*trf_oh*Dc_ohSDzn_si_s[i] + v_hco3*trf_hco3*Dc_hco3SDzn_si_s[i] \
    + v_co3*trf_co3*Dc_co3SDzn_si_s[i] + v_cahco3*trf_cahco3*Dc_cahco3SDzn_si_s[i] + v_ca*trf_ca*Dc_caSDzn_si_s[i] \
    + v_cah3sio4*trf_cah3sio4*Dc_cah3sio4SDzn_si_s[i] + v_h3sio4*trf_h3sio4*Dc_h3sio4SDzn_si_s[i] + v_h2sio4*trf_h2sio4*Dc_h2sio4SDzn_si_s[i]\
    + v_caoh*trf_caoh*Dc_caohSDzn_si_s[i] + v_h4sio4*trf_h4sio4*Dc_h4sio4SDzn_si_s[i] + v_cah2sio4*trf_cah2sio4*Dc_cah2sio4SDzn_si_s[i] \
    + v_caco3aq*trf_caco3aq*Dc_caco3aqSDzn_si_s[i])/v_h2o ;
  }
  K(E_mass,I_Si_S)         += + c[0] ;
  ...
  for(i=0;i<2;i++){
    ...
    - M_H2O*(v_k*trf_k + v_h*trf_h*Dc_hSDc_k[i] + v_oh*trf_oh*Dc_ohSDc_k[i] + v_hco3*trf_hco3*Dc_hco3SDc_k[i] \
    + v_co3*trf_co3*Dc_co3SDc_k[i] + v_cahco3*trf_cahco3*Dc_cahco3SDc_k[i] + v_ca*trf_ca*Dc_caSDc_k[i] \
    + v_cah3sio4*trf_cah3sio4*Dc_cah3sio4SDc_k[i] + v_h3sio4*trf_h3sio4*Dc_h3sio4SDc_k[i] + v_h2sio4*trf_h2sio4*Dc_h2sio4SDc_k[i]\
    + v_caoh*trf_caoh*Dc_caohSDc_k[i] + v_cah2sio4*trf_cah2sio4*Dc_cah2sio4SDc_k[i] \
    + v_caco3aq*trf_caco3aq*Dc_caco3aqSDc_k[i])/v_h2o ;
  }
  K(E_mass,I_K)         += + c[0] ;
...
for(i=0;i<2;i++){
    ...
    - M_H2O*(v_cl*trf_cl + v_h*trf_h*Dc_hSDc_cl[i] + v_oh*trf_oh*Dc_ohSDc_cl[i] + v_hco3*trf_hco3*Dc_hco3SDc_cl[i] \
    + v_co3*trf_co3*Dc_co3SDc_cl[i] + v_cahco3*trf_cahco3*Dc_cahco3SDc_cl[i] + v_ca*trf_ca*Dc_caSDc_cl[i] \
    + v_cah3sio4*trf_cah3sio4*Dc_cah3sio4SDc_cl[i] + v_h3sio4*trf_h3sio4*Dc_h3sio4SDc_cl[i] + v_h2sio4*trf_h2sio4*Dc_h2sio4SDc_cl[i]\
    + v_caoh*trf_caoh*Dc_caohSDc_cl[i] + v_cah2sio4*trf_cah2sio4*Dc_cah2sio4SDc_cl[i] \
    + v_caco3aq*trf_caco3aq*Dc_caco3aqSDc_cl[i])/v_h2o ;    
  }
  K(E_mass,I_Cl)         += + c[0] ;
...
void rs595(double **x,double **u,double **u_n,double *f,double *f_n,double *va,double *r,elem_t el,int dim,geom_t geom,double dt,double t)
/* Residu (r) */
{
...
int so595(double **x,double **u,double *f,double *va,double *s,resu_t *r,elem_t el,int dim,geom_t geom,double t)
/* Les valeurs exploitees (s) */
{
  ...
  */
  ...
  /* quantites exploitees */
  {
    ...
    double y_h2os 	  = producty_h2o(p_co2,p_co2,temperature) ;
    double gc_h2o     = product_gh2o(p_co2,p_l,temperature) ;
    double gc_h2os     = product_gh2o(p_co2,p_co2,temperature) ;
    double c_co2      = (product_co2(p_co2,p_l,temperature) > 0.) ? product_co2(p_co2,p_l,temperature) : C_CO2_eq ;/*(co2 concentration in water)(C_CO2(i) > 0.) ? C_CO2(i) : c_co2_eq ;*/
    double z_co2      = c_co2/c_co2_eq ;
    double RH		  = MIN(product_gh2o(p_l,p_l,temperature)/product_gh2o(p_co2,p_co2,temperature),1.);
    ...
    double c_h4sio4   = ((zn_si_s>=0.)?1.:product_Eta(c_co2,zn_ca_s,zn_si_s,el)) *x_s* K_Sam ;
    double eta        = ((zn_si_s>=0.)?1.:product_Eta(c_co2,zn_ca_s,zn_si_s,el)) ;
    double c_oh       = concentration_oh(c_co2,zn_si_s,zn_ca_s,c_k,c_cl,el)  ;
    double c_h        = K_h2o/c_oh ;
    /*double c_h2co3    = K_h2co3*c_co2 ;*/
    double c_hco3     = K_hco3*c_co2/c_h ;
  ...
  /* porosite */
    ...
    double phi        = phi0 + V_CH*(n_ch0 - n_ch) + V_CC*(n_cc0 - n_cc) + v_csh0*n_si_s0- v_csh*n_si_s;  
    double phimax 	  = MAX(phi0 + V_CH*(n_ch0 - n_ch) + V_CC*(n_cc0 - n_cc) + v_csh0*n_si_s0- v_csh*n_si_s,0.) ; 
   ...
   double mu_co2   = product_muco2(p_co2,temperature) ; 
    ...
    strcpy(r[i].text,"k_hco3") ; r[i].n = 1 ;
    r[i++].v[0] = K_hco3 ;    
    ...
    r[i++].v[0] = y_h2o ;
    strcpy(r[i].text,"mu_l25") ; r[i].n = 1 ;
    r[i++].v[0] = mu_l25 ;
    strcpy(r[i].text,"d_oh") ; r[i].n = 1 ;
    r[i++].v[0] = d_oh ;
    strcpy(r[i].text,"eta") ; r[i].n = 1 ;
    r[i++].v[0] = eta ;
    strcpy(r[i].text,"K_h2sio4") ; r[i].n = 1 ;
    r[i++].v[0] = K_h2sio4 ;
    strcpy(r[i].text,"phimax") ; r[i].n = 1 ;
    r[i++].v[0] = phimax ;        
    strcpy(r[i].text,"RH") ; r[i].n = 1 ;
    r[i++].v[0] = RH ;   
    strcpy(r[i].text,"kch") ; r[i].n = 1 ;
    r[i++].v[0] = K_CH ;  
    strcpy(r[i].text,"yh2os") ; r[i].n = 1 ;
    r[i++].v[0] = y_h2os ; 
    strcpy(r[i].text,"W_Ca") ; r[i].n = 1 ;
    r[i++].v[0] = W_Ca ;
    strcpy(r[i].text,"W_Si") ; r[i].n = 1 ;
    r[i++].v[0] = W_Si ;  
    strcpy(r[i].text,"W_C") ; r[i].n = 1 ;
    r[i++].v[0] = W_C ;      
    strcpy(r[i].text,"W_K") ; r[i].n = 1 ;
    r[i++].v[0] = W_K ;  
    strcpy(r[i].text,"W_K_D ") ; r[i].n = 1 ;
    r[i++].v[0] = W_K_D ;  
    strcpy(r[i].text,"W_K_psi ") ; r[i].n = 1 ;
    r[i++].v[0] = W_K_psi ;        
    strcpy(r[i].text,"W_K_dif ") ; r[i].n = 1 ;
    r[i++].v[0] = W_K_dif ;      
  }
...
/* Termes explicites (va)  */
{
  ...
  */
  for(i=0;i<2;i++) {
    ...
    double p_co2	  = (P_CO2(i) > 0.) ? P_CO2(i) : P_CO2_eq ;
    double gc_co2     = product_gco2(p_co2,temperature) ;/*(co2 concentration in gas)*/
    double gc_h2o     = product_gh2o(p_co2,p_l,temperature) ;    /*product_gh2o(p_co2,p_l,temperature) */
    double c_co2      = (product_co2(p_co2,p_l,temperature) > 0.) ? product_co2(p_co2,p_l,temperature) : C_CO2_eq ;/*(co2 concentration in water)(C_CO2(i) > 0.) ? C_CO2(i) : c_co2_eq ;*/
    double z_co2      = c_co2/c_co2_eq ;
    double zn_si_s      = ZN_Si_S(i) ;
    double zn_ca_s     = ZN_Ca_S(i) ;
    ...
    double c_h4sio4   = ((zn_si_s>=0.)?1.:product_Eta(c_co2,zn_ca_s,zn_si_s,el)) *product_Sam(c_co2,zn_ca_s,el)* K_Sam ;
    double c_oh       = concentration_oh(c_co2,zn_si_s,zn_ca_s,c_k,c_cl,el) ;
    double c_h        = K_h2o/c_oh ;
    /*double c_h2co3    = K_h2co3*c_co2 ;*/
    double c_hco3     = K_hco3*c_co2/c_h ;
    ...
    double n_si_s0	  = N_Si_S0(i) ;
    double phimax 	  = MAX(phi0 + V_CH*(n_ch0 - n_ch) + V_CC*(n_cc0 - n_cc) + v_csh0*n_si_s0- v_csh*n_si_s,0.) ;
    double phi        = MIN(phimax,0.8);   
       
    /* permeabilite */
    double k_l  = (k_intl/mu_l)*RelativePermeabilityToLiquid(p_c)*pow(phi/phi0,3.)*pow(((1.-phi0)/(1.-phi)),2.) ;
    /* permeabilite de gas */
    double mu_co2   = product_muco2(p_co2,temperature) ;
    double k_g  = (k_intg/mu_co2)*RelativePermeabilityToGas(p_c)*pow(phi/phi0,3.)*pow(((1.-phi0)/(1.-phi)),2.) ;
    
    /* tortuosite gaz */
    /*double tau  = pow(phi,1/3)*pow(s_g,7/3) ;*/
    double tau  = pow(phi,1.74)*pow(s_g,3.20) ;
    /* tortuosite liquide */
    double iff    = (phi>0.25) ? 0.00029*exp(9.95*phi)/(1.+625.*pow((1-s_l),4.)):(phi/0.25)*0.00029*exp(9.95*phi)/(1.+625.*pow((1-s_l),4.)) ;/*0.00029*exp(9.95*phi)/(1.+625.*pow((1-s_l),4.)) ;*/
...
{
  double r_h[2],r_oh[2] ;
  double r_co2[2],r_hco3[2],r_co3[2],r_caco3aq[2],r_caoh[2] ;
  ...
  */
  ...
  /* Gradients */
  {
    ...
    double w_m     	  = - KD_M*grd_p_l 					- M_CO2*KD_GCO2*grd_p_g	- M_H2Og*KD_GH2O*grd_p_g \
						...
						+ M_H2O*KF_CO2*grd_co2*v_co2/v_h2o; /*d*/
    ...
    W_C     = w_co2 + w_hco3 + w_co3 + w_cahco3 + w_caco3aq ;
...
double product_Sam(double c_co2,double zn_ca_s,elem_t el)
{
  double z_co2 =  c_co2/c_co2_eq ;
  double zp_ch = NEGEXP(zn_ca_s)/MAX(z_co2,1.) ; 
  double x_sam = F_SAM(zp_ch) ;
  return(x_sam) ;
}

double product_Eta(double c_co2,double zn_ca_s,double zn_si_s,elem_t el)
{
  double z_co2 =  c_co2/c_co2_eq ;
  double zp_ch = NEGEXP(zn_ca_s)/MAX(z_co2,1.) ; 
  double x_sam = F_SAM(zp_ch) ;
  double x_tobI = courbe(zp_ch,el.mat->cb[7]) ;
  double x_tobII = courbe(zp_ch,el.mat->cb[8]) ;
  double x_jen = courbe(zp_ch,el.mat->cb[9]) ;
  double Y_sam = 1. ;
  double Y_tobI = 2.4 ;
  double Y_tobII = 1.8 ;
  double Y_jen = 0.9 ;
  double err,tol = 1e-8 ;
  double x0 = NEGEXP(zn_si_s);
  double x  = x0 ;
  int    i = 0 ;
  
    do {
    double f  =  x_sam*pow(x,Y_sam) + x_tobI*pow(x,Y_tobI) + x_tobII*pow(x,Y_tobII) + x_jen*pow(x,Y_jen)- NEGEXP(zn_si_s);
    double df = Y_sam*x_sam*pow(x,Y_sam-1.) + Y_tobI*x_tobI*pow(x,Y_tobI-1.) + Y_tobII*x_tobII*pow(x,Y_tobII-1.) + Y_jen*x_jen*pow(x,Y_jen-1.) ;
    double dx = -f/df ;
    err = fabs(dx/x) ;
    x += dx ;
    if(i++ > 20) {
      printf("x0 = %e\n",x0) ;
      printf("x  = %e\n",x) ;
      arret("product_Eta : non convergence") ;
    }
  } while(err > tol) ;
...
{
  double p_co2     = pascal_co2/1.e5;   /*unit of pressure:bar*/
  double p_h2ol	   = p_l/1.e5 ; /*MAX(p_l/1.e5,1.) */
  double R         = 83.14472 ;   /*cm3*bar*K-1*mol-1*/
  double A_CO2     = 7.54e7 - 4.13e4*T ;/*bar*cm⁶*K0.5*mol^-2*/
  double B_CO2     = 27.80 ; /*cm³/mol*/
  double B_H2O     = 18.18 ; /*cm³/mol*/
  ...
  double A         = K0_h2o*exp((p_h2ol-P0)*Vav_h2o/(R*T))/(p_tot*fi_h2o) ;
  double B         = p_tot*fi_co2*exp(-(p_h2ol-P0)*Vav_gco2/(R*T))/(55.508*K0_gco2) ;
  double y_h2o     = MIN((1.-B)/(1./A-B),1) ; /*MIN((1.-B)/(1./A-B),0.1) ;*/
  double x_co2     = B*(1.-y_h2o) ;
...
double product_k(double temp, double a, double b, double c, double d, double e) 
/*Nagra/PSI Chemical Thermodynamic Data Base Version 01/01 (Nagra/PSI TDB 01/01)                    */
{
double logkt = a + b * temp + c/temp + d * log10(temp) + e/(temp*temp) ;
double kt = pow(10.,logkt);
  return(kt) ;
}
