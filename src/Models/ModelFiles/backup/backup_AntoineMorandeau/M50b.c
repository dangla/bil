...
#define K(i,j)    (k[(i)*2*NEQ+(j)])
  ...
  */
  for(i=0;i<2;i++) {
    ...
    double dx_hco3sdx_co2     =   x_oh*dx_h2co3sdx_co2/k_1 ;
    double dx_co3sdx_co2      =   k_co3*x_oh*dx_hco3sdx_co2 ;
    
    double dx_casdx_co2       = - x_ca/x_co2 ;
    double dx_caohsdx_co2     = - x_caoh/x_co2 ;
    double dx_caoh2aqsdx_co2  = - x_caoh2aq/x_co2 ;
    
    double dq_chsdx_co2       = - q_ch/x_co2 ;
    double dx_h4sio4sdx_co2   =   DIAP_SH(q_ch)*dq_chsdx_co2 ;
    double dx_h3sio4sdx_co2   =   x_h3sio4*(dx_h4sio4sdx_co2/x_h4sio4) ;
    double dx_h2sio4sdx_co2   =   x_h2sio4*(dx_h3sio4sdx_co2/x_h3sio4) ;
    double dx_cah2sio4sdx_co2 =   x_cah2sio4*(dx_h2sio4sdx_co2/x_h2sio4 - 1/x_co2) ;
    double dx_cah3sio4sdx_co2 =   x_cah3sio4*(dx_h3sio4sdx_co2/x_h3sio4 - 1/x_co2) ;
    
    double dx_nahco3sdx_co2   =   k_nahco3*x_na*dx_hco3sdx_co2 ;
    double dx_naco3sdx_co2    =   k_naco3/k_e*x_na*x_oh*dx_hco3sdx_co2 ;
    
    double dx_h2osdx_co2      = -(v_h2co3*dx_h2co3sdx_co2 + v_hco3*dx_hco3sdx_co2 + v_co3*dx_co3sdx_co2 + v_ca*dx_casdx_co2 + v_caoh*dx_caohsdx_co2 + v_caoh2aq*dx_caoh2aqsdx_co2 + v_h2sio4*dx_h2sio4sdx_co2 + v_h3sio4*dx_h3sio4sdx_co2 + v_h4sio4*dx_h4sio4sdx_co2 + v_cah2sio4*dx_cah2sio4sdx_co2 + v_cah3sio4*dx_cah3sio4sdx_co2 + v_nahco3*dx_nahco3sdx_co2 + v_naco3*dx_naco3sdx_co2)/v_h2o ;
    
    double drho_lsdx_co2      = M_H2O*dx_h2osdx_co2 + M_H2CO3*dx_h2co3sdx_co2 + M_HCO3*dx_hco3sdx_co2 + M_CO3*dx_co3sdx_co2 + M_Ca*dx_casdx_co2 + M_CaOH*dx_caohsdx_co2 + M_CaOH2aq*dx_caoh2aqsdx_co2 + M_H2SiO4*dx_h2sio4sdx_co2 + M_H3SiO4*dx_h3sio4sdx_co2 + M_H4SiO4*dx_h4sio4sdx_co2 + M_CaH2SiO4*dx_cah2sio4sdx_co2 + M_CaH3SiO4*dx_cah3sio4sdx_co2 + M_NaHCO3*dx_nahco3sdx_co2 + M_NaCO3*dx_naco3sdx_co2 ;
    
    double dx_c_lsdx_co2  = dx_h2co3sdx_co2 + dx_hco3sdx_co2 + dx_co3sdx_co2 + dx_nahco3sdx_co2 + dx_naco3sdx_co2 ;
    double dx_ca_lsdx_co2 = dx_casdx_co2 + dx_caohsdx_co2 + dx_caoh2aqsdx_co2 + dx_cah2sio4sdx_co2 + dx_cah3sio4sdx_co2 ;
    double dx_na_lsdx_co2 = dx_nahco3sdx_co2 + dx_naco3sdx_co2 ;
    double dx_si_lsdx_co2 = dx_h2sio4sdx_co2 + dx_h3sio4sdx_co2 + dx_h4sio4sdx_co2 + dx_cah2sio4sdx_co2 + dx_cah3sio4sdx_co2 ;
    double dx_qsdx_co2    = z_hco3*dx_hco3sdx_co2 + z_co3*dx_co3sdx_co2 \
       + z_ca*dx_casdx_co2 + z_caoh*dx_caohsdx_co2 \
       + z_h3sio4*dx_h3sio4sdx_co2 + z_h2sio4*dx_h2sio4sdx_co2 \
       + z_cah3sio4*dx_cah3sio4sdx_co2 \
       + z_naco3*dx_naco3sdx_co2 ;

    /* solid */
    double dx_cshsdx_co2      =  DX_CSH(q_ch)*dq_chsdx_co2 ;
    double dz_cshsdx_co2      =  DZ_CSH(q_ch)*dq_chsdx_co2 ;
    double dv_cshsdx_co2      =  DV_CSH(q_ch)*dq_chsdx_co2 ;
    ...
    double dx_hco3sdx_oh     =   x_hco3/x_oh ;
    double dx_co3sdx_oh      =   x_co3*2/x_oh ;
    
    double dx_casdx_oh       = - x_ca*2/x_oh ;
    double dx_caohsdx_oh     = - x_caoh/x_oh ;
    double dx_cahco3sdx_oh   = - x_cahco3/x_oh ;
    
    double dx_h3sio4sdx_oh   =   x_h3sio4/x_oh ;
    double dx_h2sio4sdx_oh   =   x_h2sio4*2/x_oh ;
    double dx_cah3sio4sdx_oh = - x_cah3sio4/x_oh ;
    
    double dx_naohsdx_oh     =   x_naoh/x_oh ;
    double dx_nahco3sdx_oh   =   x_nahco3/x_oh ;
    double dx_naco3sdx_oh    =   x_naco3*2/x_oh ;
    double dx_kohsdx_oh      =   x_koh/x_oh ;
    
    double dx_h2osdx_oh      = -(v_oh + v_h*dx_hsdx_oh \
         + v_hco3*dx_hco3sdx_oh + v_co3*dx_co3sdx_oh \
         + v_ca*dx_casdx_oh + v_caoh*dx_caohsdx_oh + v_cahco3*dx_cahco3sdx_oh \
         + v_h2sio4*dx_h2sio4sdx_oh + v_h3sio4*dx_h3sio4sdx_oh \
         + v_cah3sio4*dx_cah3sio4sdx_oh \
         + v_naoh*dx_naohsdx_oh + v_nahco3*dx_nahco3sdx_oh + v_naco3*dx_naco3sdx_oh \
         + v_koh*dx_kohsdx_oh)/v_h2o ;
    
    double drho_lsdx_oh      = M_H*dx_hsdx_oh + M_OH + M_H2O*dx_h2osdx_oh \
         + M_HCO3*dx_hco3sdx_oh + M_CO3*dx_co3sdx_oh \
         + M_Ca*dx_casdx_oh + M_CaOH*dx_caohsdx_oh + M_CaHCO3*dx_cahco3sdx_oh \
         + M_H2SiO4*dx_h2sio4sdx_oh + M_H3SiO4*dx_h3sio4sdx_oh \
         + M_CaH3SiO4*dx_cah3sio4sdx_oh \
         + M_NaHCO3*dx_nahco3sdx_oh  + M_NaOH*dx_naohsdx_oh + M_NaCO3*dx_naco3sdx_oh \
         + M_KOH*dx_kohsdx_oh ;
         
    double dx_c_lsdx_oh  = dx_hco3sdx_oh + dx_co3sdx_oh + dx_nahco3sdx_oh + dx_naco3sdx_oh + dx_cahco3sdx_oh ;
    double dx_ca_lsdx_oh = dx_casdx_oh + dx_caohsdx_oh + dx_cahco3sdx_oh + dx_cah3sio4sdx_oh ;
    double dx_na_lsdx_oh = dx_naohsdx_oh + dx_nahco3sdx_oh + dx_naco3sdx_oh ;
    double dx_k_lsdx_oh  = dx_kohsdx_oh ;
    double dx_si_lsdx_oh = dx_h2sio4sdx_oh + dx_h3sio4sdx_oh + dx_cah3sio4sdx_oh ;
    double dx_qsdx_oh    = z_h*dx_hsdx_oh + z_oh \
       + z_hco3*dx_hco3sdx_oh + z_co3*dx_co3sdx_oh \
       + z_ca*dx_casdx_oh + z_caoh*dx_caohsdx_oh + z_cahco3*dx_cahco3sdx_oh \
    ...
    /* ... par rapport a x_k */
    double dx_kohsdx_k        =  k_koh/k_e*x_oh;
    ...
    */
    ...
    K(E_C+j,I_CO2+j)   += volume[i]*(phi_g + phi_l*dx_c_lsdx_co2 + dphisdx_co2*(s_g*x_co2 + s_l*x_c_l)) ;
    ...
    */
    ...
    K(E_mass+j,I_CO2+j)   += volume[i]*(phi_g*M_CO2 + phi_l*drho_lsdx_co2 + dphisdx_co2*(s_l*rho_l + s_g*rho_g) + M_CaOH2*dn_chsdx_co2 + dM_CSHsdx_co2*n_si_s) ;
    ...
    */
    ...
    K(E_Ca+j,I_CO2+j)    += volume[i]*(phi_l*dx_ca_lsdx_co2 + dn_ca_ssdx_co2 + dphisdx_co2*s_l*x_ca_l) ;
    ...
    */
    ...
    Dx_hco3SDx_co2[i]     = dx_hco3sdx_co2 ;
    Dx_co3SDx_co2[i]      = dx_co3sdx_co2 ;
    Dx_caSDx_co2[i]       = dx_casdx_co2 ;
    Dx_caohSDx_co2[i]     = dx_caohsdx_co2 ;
    Dx_caoh2aqSDx_co2[i]  = dx_caoh2aqsdx_co2 ;
    Dx_h2sio4SDx_co2[i]   = dx_h2sio4sdx_co2 ;
    Dx_h3sio4SDx_co2[i]   = dx_h3sio4sdx_co2 ;
    Dx_h4sio4SDx_co2[i]   = dx_h4sio4sdx_co2 ;
    Dx_cah2sio4SDx_co2[i] = dx_cah2sio4sdx_co2 ;
    Dx_cah3sio4SDx_co2[i] = dx_cah3sio4sdx_co2 ;
    Dx_nahco3SDx_co2[i]   = dx_nahco3sdx_co2 ;
    Dx_naco3SDx_co2[i]    = dx_naco3sdx_co2 ;
    
    Dx_hSDx_oh[i]         = dx_hsdx_oh ;
    Dx_hco3SDx_oh[i]      = dx_hco3sdx_oh ;
    Dx_co3SDx_oh[i]       = dx_co3sdx_oh ;
    Dx_caSDx_oh[i]        = dx_casdx_oh ;
    Dx_caohSDx_oh[i]      = dx_caohsdx_oh ;
    ...
    Dx_nahco3SDx_oh[i]    = dx_nahco3sdx_oh ;
