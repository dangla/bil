...
double (FEM_ComputeUnknown)(FEM_t* fem,double const* const* u,IntFct_t* intfct,int p,int inc)
...
double* (FEM_ComputeDisplacementVector)(FEM_t* fem,double const* const* u,IntFct_t* intfct,int p,int inc)
...
double* (FEM_ComputeUnknownGradient)(FEM_t* fem,double const* const* u,IntFct_t* intfct,int p,int inc)
...
double* (FEM_ComputeLinearStrainTensor)(FEM_t* fem,double const* const* u,IntFct_t* intfct,int p,int inc)
...
/* FEM_Compute functions in the form (FEM_t*,IntFct_t*,double const* const*,int) */
...
#if 0
double* (FEM_ComputeUnknowns)(FEM_t* fem,IntFct_t* intfct,double const* const* u,int inc)
...
double* (FEM_ComputeUnknownGradients)(FEM_t* fem,IntFct_t* intfct,double const* const* u,int inc)
...
double* (FEM_ComputeLinearStrainTensors)(FEM_t* fem,IntFct_t* intfct,double const* const* u,int inc)
